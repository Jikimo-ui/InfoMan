...
CREATE TABLE Computer (
  ...
  TECH_ID CHAR(6) NOT NULL, -- CAN BE NULL --
  PRIMARY KEY (PC_ID),
  KEY TECH_ID_idx (TECH_ID),
  CONSTRAINT TECH_ID_FK FOREIGN KEY (TECH_ID) REFERENCES Technician (TECH_ID)
);
...
CREATE TABLE Customer(
    ...
    CUS_MEMBERSHIP_STAT ENUM('BASIC','PREMUIM') NOT NULL,
    PC_ID CHAR(6) NOT NULL,
	PRIMARY KEY (CUS_ID),
	KEY PC_ID_idx (PC_ID),
...
CREATE TABLE Access_Hours(
    ...
    CUS_ID CHAR(6) NOT NULL,
    CSHR_ID CHAR(6) NOT NULL, -- POSSIBLE NULL --
	PRIMARY KEY (ACC_TIME),
	KEY CUS_ID_idx (CUS_ID),
    CONSTRAINT CUS_ID_ACC_FK FOREIGN KEY (CUS_ID) REFERENCES Customer (CUS_ID),
    KEY CSHR_ID_idx (CSHR_ID),
    CONSTRAINT CSHR_ID_ACC_FK FOREIGN KEY (CSHR_ID) REFERENCES Cashier (CSHR_ID)
);
...
CREATE TABLE Transact(
    ...
    KEY CUS_ID_idx (CUS_ID),
    CONSTRAINT CUS_ID_TRNSC_FK FOREIGN KEY (CUS_ID) REFERENCES Customer (CUS_ID),
    KEY CSHR_ID_idx (CSHR_ID),
    CONSTRAINT CSHR_ID_TRNSC_FK FOREIGN KEY (CSHR_ID) REFERENCES Cashier (CSHR_ID)
);
...
('C002', 'asmith', 'mypwd456', 'Anna', 'Smith', 'PREMUIM', 'PC002'),
